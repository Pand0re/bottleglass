<template>
  <div class="container">
    ...
    <div class="input-group shipping-checkbox">
      <input v-model="bShipping" type="checkbox" id="shipping">
      <label for="shipping">Frais de ports (6.00 CHF)</label>
    </div>
    ...
    <div class="cart">
      <template v-for="item in $parent.$parent.ShoppingCart">
        <div class="item">
          <span>
            {{ $t(item.nom_pro) }}
          </span>
